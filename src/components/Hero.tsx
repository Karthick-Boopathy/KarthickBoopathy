    ...
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 border-b border-slate-200 bg-cad-grid overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-between gap-3 pb-6 mb-8 border-b border-slate-200/80 text-xs font-mono text-slate-500"
        >
          <div className="flex items-center space-x-3">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-slate-100 border border-slate-300 text-slate-700 font-semibold shadow-2xs">
            ...
            >
              ...
              <span>
                ...
                <span className="underline underline-offset-2 decoration-blueprint-300 group-hover:decoration-blueprint-600">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            {/* Core Hook */}
            <motion.p variants={itemVariants} className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl font-normal">
              A hands-on builder operating at the convergence of{' '}
              <span className="text-slate-900 font-medium">vehicle systems engineering</span>,{' '}
              <span className="text-slate-900 font-medium">production software architecture</span>, and{' '}
              <span className="text-slate-900 font-medium">independent enterprise</span>. From ADAS camera calibration and EV powertrains to local LLM trading bots and full-stack e-commerce.
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              <motion.div
                ...
                className="p-3 bg-white border border-slate-200 hover:border-blueprint-300 rounded shadow-2xs hover:shadow-xs transition-colors flex items-start gap-3"
              >
            ...
            <motion.div variants={itemVariants} className="pt-3 flex flex-wrap items-center gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 hover:bg-blueprint-600 text-white font-mono text-xs uppercase tracking-wider font-semibold rounded transition-colors shadow-sm hover:shadow-md"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02, y: -1 }}
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-2 px-5 py-3 bg-white hover:bg-slate-50 text-slate-800 font-mono text-xs uppercase tracking-wider font-semibold rounded border border-slate-300 hover:border-slate-400 transition-colors shadow-2xs"
              >
            ...
            <motion.div variants={itemVariants} className="pt-2 flex flex-wrap items-center gap-4 text-xs font-mono text-slate-500 border-t border-slate-200/60">
              <a
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            ...
            >
              ...
              <motion.div
                ...
                className="p-3 bg-white border border-slate-300 rounded shadow-md hover:shadow-lg transition-shadow relative"
              >
                ...
                <figure className="relative aspect-4/5 bg-slate-100 rounded border border-slate-200 overflow-hidden flex items-center justify-center m-0 group">
                  {!imgError ? (
                    <img
                      src={PHOTO_PATH}
                  ...
                  <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between text-[9px] font-mono px-2 py-1 bg-white/90 backdrop-blur-xs rounded border border-slate-200 text-slate-600 shadow-2xs">
